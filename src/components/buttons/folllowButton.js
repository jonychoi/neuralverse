...
export const FollowButton = ({following, scale = 1}) => {
    ...
    return (
        <Flex to="cursor" cursorOpaFalse={true} onMouseOver={() => setHover(true)} onMouseLeave={() => setHover(false)} bg={hover ? redLowColor : blueLowColor} style={{transform: `scale(${scale})`}} align="center" height="20px" justify="center" margin="margin-bottom: 3px;" br="20px">

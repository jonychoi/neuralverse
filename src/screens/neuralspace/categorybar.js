    ...
    return (
        <TaskWrap>
            <Col justify="center" align="center" position="absolute" zIndex={101} 
                ...
                width="70%" height="100%" bg={darkMode ? "black" : "white"}>
...
export const CategoryBar = ({darkMode}) => {
    return (
        <Box position="fixed" bg={bgStyler(darkMode)} padding="padding: 15px;" zIndex={100} width="380px;" 
            height={Height - 80 + 'px'} style={{right: 0, top: 80, transition: 'all 300ms'}}>
            ...
            <Flex position="absolute" zIndex={100} style={{right: 15, top: 15}}>
                <CloseIcon width={30} height={30} bg={bgStyler(darkMode)} stroke="rgb(100, 100, 100)" />
            </Flex>
